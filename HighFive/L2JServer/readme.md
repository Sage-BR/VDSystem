...
- JDK 14
- install add jar on classpath and import near the end VDSystemManager.getInstance(); on GameServer.java
...
**Installation**
![https://github.com/Sage-BR/VDSystem/tree/master/HighFive/aVa/VDSystem/Patch.diff](Patch.diff)
